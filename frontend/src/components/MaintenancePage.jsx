...
import {
  ...
  Assignment, TrendingUp, Notifications, PictureAsPdf,
  PlayArrow, Pause, Settings, Refresh
...
export default function MaintenancePage() {
  ...
  const [maintenanceData] = useState({
    stats: {
      ...
      total_maintenance_cost: 12847,
      scheduled_this_week: 12
    },
    upcomingInspections: [
      {
        id: 1,
        hydrant_number: 'MLT-001',
        location: '555 Main Street East',
      ...
      {
        id: 2,
        hydrant_number: 'MLT-002',
        location: '55 Ontario Street South',
        inspection_type: 'Flow Test',
        due_date: '2025-11-18',
        priority: 'HIGH',
        regulatory_required: true,
      ...
      {
        id: 3,
        hydrant_number: 'MLT-011',
        location: '2468 Old Mill Road',
        inspection_type: 'Emergency Repair Follow-up',
        due_date: '2025-11-05',
        priority: 'CRITICAL',
        regulatory_required: false,
        last_inspection: '2025-02-28'
      }
    ],
    activeWorkOrders: [
      {
        id: 'WO-2025-001',
        hydrant_number: 'MLT-011',
        title: 'Critical Maintenance - Multiple Issues',
      ...
      {
        id: 'WO-2025-002',
        hydrant_number: 'MLT-006',
        title: 'Paint Maintenance - Fading Paint',
        category: 'PAINT_MAINTENANCE',
        priority: 'MEDIUM',
        status: 'IN_PROGRESS',
        assigned_to: 'Rich Cabral',
      ...
      {
        id: 'WO-2025-003',
        hydrant_number: 'MLT-003',
        title: 'Valve Lubrication',
    ...
    recentActivity: [
      {
        ...
        type: 'INSPECTION',
        hydrant_number: 'MLT-001',
        description: 'Annual inspection completed - PASS',
        date: '2025-10-28',
      ...
      },
      {
        ...
        type: 'WORK_ORDER',
        hydrant_number: 'MLT-003',
        description: 'Valve lubrication work order completed',
        date: '2025-10-25',
        inspector: 'Rich Cabral',
        status: 'COMPLETED'
      },
      {
        id: 3,
        type: 'FLOW_TEST',
        hydrant_number: 'MLT-008',
        description: 'NFPA 291 flow test - 2,234 GPM (Class AA)',
        date: '2025-10-22',
        inspector: 'Rich Cabral',
        status: 'EXCELLENT'
      }
  ...
  const loadHydrants = async () => {
    try {
      ...
      setError('Error loading hydrant data');
    }
  };
      ...
      <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 3 }}>
        <div>
          ...
          <Typography variant="body2" color="text.secondary">
            Preventive maintenance, compliance tracking & audit management
          </Typography>
        </div>
              ...
              <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <div>
                  <Typography variant="h4" sx={{ fontWeight: 700, color: 'success.main' }}>
                    {maintenanceData.stats.compliance_rate}%
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
                    Compliance Rate
                  </Typography>
          ...
          <Card>
            <CardContent>
              <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <div>
                  <Typography variant="h4" sx={{ fontWeight: 700, color: 'primary.main' }}>
                    {maintenanceData.stats.scheduled_this_week}
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
                    Scheduled This Week
                  </Typography>
              ...
              <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <div>
                  <Typography variant="h4" sx={{ fontWeight: 700, color: 'warning.main' }}>
                    {maintenanceData.stats.overdue_inspections}
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
                    Overdue Inspections
                  </Typography>
              ...
              <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <div>
                  <Typography variant="h4" sx={{ fontWeight: 700, color: 'info.main' }}>
                    {maintenanceData.stats.active_work_orders}
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
                    Active Work Orders
                  </Typography>
              ...
              <Stack spacing={2}>
                <div>
                  <Stack direction="row" justifyContent="space-between" sx={{ mb: 1 }}>
                    <Typography variant="body2">Inspections Completed</Typography>
                    <Typography variant="body2" sx={{ fontWeight: 600 }}>
                      {maintenanceData.stats.completed_this_month} / {Math.round(maintenanceData.stats.total_inspections / 12)}
                    </Typography>
                  </Stack>
                  <LinearProgress 
                    variant="determinate" 
                    value={(maintenanceData.stats.completed_this_month / Math.round(maintenanceData.stats.total_inspections / 12)) * 100} 
                ...
                <div>
                  <Stack direction="row" justifyContent="space-between" sx={{ mb: 1 }}>
                    ...
                    <Typography variant="body2" sx={{ fontWeight: 600 }}>
                      {maintenanceData.stats.avg_completion_time} days
                    </Typography>
                  </Stack>
                  <LinearProgress 
                    variant="determinate" 
            ...
            <CardContent>
              ...
              <Stack spacing={2}>
                <Stack direction="row" justifyContent="space-between">
                  <Typography variant="body2">Total Maintenance Costs (YTD)</Typography>
                  <Typography variant="h6" color="primary.main">
                    ${maintenanceData.stats.total_maintenance_cost.toLocaleString()}
                  </Typography>
                </Stack>
                <Stack direction="row" justifyContent="space-between">
                  <Typography variant="body2">Average Cost per Hydrant</Typography>
                  <Typography variant="body2" sx={{ fontWeight: 600 }}>
                    ${Math.round(maintenanceData.stats.total_maintenance_cost / maintenanceData.stats.total_inspections)}
                  </Typography>
                </Stack>
                <Stack direction="row" justifyContent="space-between">
                  <Typography variant="body2">Preventive vs Reactive</Typography>
                  ...
                  <TableRow key={inspection.id}>
                    <TableCell>
                      <Stack>
                        ...
                        {inspection.regulatory_required && (
                          <Chip label="Required" size="small" color="info" sx={{ width: 'fit-content' }} />
                        )}
                      </Stack>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <Typography variant="body2">
                        {dayjs(inspection.due_date).format('MMM DD, YYYY')}
                      </Typography>
                      {dayjs(inspection.due_date).isBefore(dayjs()) && (
                    ...
                    <TableCell>
                      <Typography variant="body2" color="text.secondary">
                        {dayjs(inspection.last_inspection).format('MMM DD, YYYY')}
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Button 
              ...
              <TableBody>
                {maintenanceData.activeWorkOrders.map((wo) => (
                  <TableRow key={wo.id}>
                    ...
                    <TableCell>
                      <Box sx={{ width: 80 }}>
                        <LinearProgress 
                          variant="determinate" 
                          value={wo.progress}
                          color={getProgressColor(wo.progress)}
                    ...
                    <TableCell>
                      <Typography variant="body2">{wo.assigned_to}</Typography>
                    </TableCell>
                    <TableCell>
                      <Typography variant="body2">
                        {dayjs(wo.target_date).format('MMM DD, YYYY')}
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Typography variant="body2" sx={{ fontWeight: 600 }}>
                ...
                <Stack direction="row" justifyContent="space-between" alignItems="center">
                  <div>
                    <Typography variant="body1" sx={{ fontWeight: 600 }}>
                      {activity.type.replace('_', ' ')} - {activity.hydrant_number}
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
                      {activity.description}
                    </Typography>
                    <Typography variant="caption" color="text.secondary">
                      {dayjs(activity.date).format('MMM DD, YYYY')} by {activity.inspector}
                    </Typography>
                  </div>
                  <Chip 
              ...
              <Card>
                <CardContent>
                  ...
                  <Stack spacing={2}>
                    ...
                    <Stack direction="row" justifyContent="space-between">
                      <Typography variant="body2">Documentation Complete</Typography>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={12} sm={6} md={3}>
                      <Stack alignItems="center">
                        ...
                        <Typography variant="body2" align="center">Photo Documentation</Typography>
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                      <Stack alignItems="center">
                        <CheckCircle color="success" sx={{ fontSize: 32, mb: 1 }} />
                        <Typography variant="body2" align="center">Inspector Certifications</Typography>
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                      <Stack alignItems="center">
                        <CheckCircle color="success" sx={{ fontSize: 32, mb: 1 }} />
                        <Typography variant="body2" align="center">Maintenance Records</Typography>
                        <Typography variant="caption" color="success.main">Complete</Typography>
                      </Stack>
                    </Grid>
                    <Grid item xs={12} sm={6} md={3}>
                      <Stack alignItems="center">
                        <CheckCircle color="success" sx={{ fontSize: 32, mb: 1 }} />
                        <Typography variant="body2" align="center">Compliance Reports</Typography>
