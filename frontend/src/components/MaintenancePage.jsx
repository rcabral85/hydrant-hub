...
const loadMaintenanceData = async () => {
  try {
    ...
    const [hydrantsRes, inspectionsRes, workOrdersRes, statsRes, complianceRes] = await Promise.all([
      api.get('/hydrants', config),
      api.get('/maintenance/inspections', config),
      api.get('/maintenance/work-orders', config),
      api.get('/maintenance/stats', config),
      api.get('/maintenance/compliance/schedule', config)
    ]);
    
    setHydrants(hydrantsRes.data.hydrants || []);
